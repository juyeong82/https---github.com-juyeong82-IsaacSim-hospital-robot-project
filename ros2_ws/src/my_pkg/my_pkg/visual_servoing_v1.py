...
class VisualServoBase(Node):
    def __init__(self):
        ...
        self.dist_tolerance = 0.001 # 거리 허용 오차 (m)
        self.angle_tolerance = 0.001 # 각도 허용 오차 (rad)
        ...
        # 속도 빠르게
        # self.k_v = 1.5      # 속도 게인 (오차가 클 때 더 과감하게 가속)
        # self.k_w = 1.5      # 회전 게인 (회전 반응 속도 향상)

        # self.max_v = 0.5    # 최대 속도: 0.15 -> 0.5 (초속 50cm)
        # self.max_w = 1.0    # 회전 속도: 0.3 -> 1.0 (초당 약 60도 회전)
